...
app.use(cors({
  origin: [
    'http://44.210.94.69:8036', // Login Server
    'http://44.210.94.69:3412', // Employee Server
    'http://44.210.94.69:5500', // Live Server (Default)
    'http://127.0.0.1:5500', // Live Server (IP)
    //'http://44.210.94.69:8037'  // Live Server (Alternate)
  ]
}));
